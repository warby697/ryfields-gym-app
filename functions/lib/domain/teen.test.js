...
import { requiresGuardian, normaliseGuardianEmail, isEligibleGuardian, selectGuardian } from './teen.js';
...
describe('isEligibleGuardian', () => {
    const active = (membershipTypeId, membershipStatus = 'active') => ({ id: 'x', membershipTypeId, membershipStatus });
...
describe('selectGuardian', () => {
    const c = (id, membershipTypeId, membershipStatus = 'active') => ({ id, membershipTypeId, membershipStatus });
