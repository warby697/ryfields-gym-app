...
function londonDateTime(dateKey: string, time: string) {
...
export const generateClassSessions = onSchedule(
  { schedule: 'every day 01:15', timeZone: 'Europe/London' },
  async () => {
    ...
    const candidates: Array<{ ref: DocumentReference; data: Record<string, unknown> }> = []
